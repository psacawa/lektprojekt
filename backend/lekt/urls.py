...
urlpatterns = [
    ...
    path(r"pair-counts/", views.PairCountsView.as_view(), name="pair-counts"),
    path(
        r"supported-language-pairs/",
        views.SupportedLanguagePairsView.as_view(),
        name="supported-language-pairs",
    ),
]
